          ...
          @foreach ($all_donasi as $donasi)
              <tr>
                  ...
                  <td class="text-center"> 
                    <a href="/admin/donasi-barang/{{ $donasi->id_donasi }}" class="badge bg-info"><span data-feather="eye">Detail</span></a>
                    <form action="/admin/donasi-barang/{{ $donasi->id_donasi }}" class="d-inline" method="POST">
                        @method('delete')
                        @csrf
